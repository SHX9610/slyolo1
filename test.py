...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_def", type=str, default="config/yolov.cfg", help="path to model definition file")
    parser.add_argument("--data_config", type=str, default="config/sl.data", help="path to data config file")
    parser.add_argument("--weights_path", type=str, default="checkpoints/yolov3_ckpt_539.pth", help="path to weights file")
